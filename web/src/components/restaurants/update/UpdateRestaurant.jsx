import * as S from "./updateeRestaurant.styles";
...
import { updateRestaurantSchema } from "../../../validation/restaurant/restaurant.validation";

// RTKQ
import { useUpdateRestaurantMutation } from "../../../store/restaurants/restaurantsSlice";
import toast from "react-hot-toast";

function UpdateRestaurant({ isOpen, onClose, restaurant, onSuccess }) {
  ...
  useEffect(() => {
    if (restaurant) {
      ...
      setImagePreview(restaurant.imgUrl || null);
    }
  }, [restaurant, reset]);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const errorMessage = error?.data?.error || "Failed to update restaurant";
  ...
  return (
    <Modal title="Update Restaurant" onClose={handleClose}>
      <S.Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <S.FormGrid>
          {/* Name */}
          <S.FormGroup>
            <S.Label>Restaurant Name</S.Label>
            <Controller
              name="name"
              control={control}
              render={({ field }) => (
